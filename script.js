...
// If no tasks are saved yet, use an empty array.
let tasks = JSON.parse(localStorage.getItem("tasks")) || [];   //converts a JSON string into an executable JavaScript object or value

// ======================= NEW 2 =======================
// Function to save the tasks array into Local Storage.
// Take the string, save it in Local Storage.
function saveTasks() {
...
// ======================= NEW 6 =======================
// Display saved tasks automatically
// when the page loads.
displayTasks();